...
window.goToProductDetailPage = (productID) => {
  let url = `/pages/customer/pages/product-detail/index.html?id=${productID}`;
  window.location = url;
};
        ...
        price + price * 0.15
              ...
              <div class="product-btns">
                ...
                <button class="quick-view">
                  <i class="fa fhttps://smoky-mini-lazada-be.onrender.com/api/product/image/1684477903487-starlight-air-m2.jpega-eye"></i
